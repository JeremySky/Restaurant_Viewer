...
An iOS app leveraging **Yelp's Search API** 🍕 and **Swift's CoreLocation** 📍 to show restaurants based on user-selected criteria like category and sort order 🔍. Browse nearby dining spots 🌆✨ with a smooth, card-based UI 🃏.

---

## 🚀 Features

- Fetch restaurants using **Yelp's Search API** 🍴  
- Use **CoreLocation** to get your current location 📍  
...
- **Favorite restaurants** 💖 are persisted across app launches 
